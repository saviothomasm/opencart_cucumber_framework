...
public class steps {
	...
	@Then("check User navigates to MyAccount Page by passing Email and Passoword with excel row {string}")
	public void check_user_navigates_to_my_page_by_passing_email_and_password_with_excel_data(String rows)
	{
